...
bool solve() {
    ...
    assert(-1000000 <= x1 && x1 <= 1000000);
    assert(-1000000 <= y1 && y1 <= 1000000);
    assert(-1000000 <= x2 && x2 <= 1000000);
    assert(-1000000 <= y2 && y2 <= 1000000);
    assert(-1000000 <= x3 && x3 <= 1000000);
    assert(-1000000 <= y3 && y3 <= 1000000);
    assert(x1 != 0 || y1 != 0);
    assert(x2 != 0 || y2 != 0);
    assert(x3 != 0 || y3 != 0);
    ...
    std::cout << "YES\n";
    std::cout << a << ' ' << b << '\n';
    assert(-2000000000000LL <= a <= 2000000000000LL);
